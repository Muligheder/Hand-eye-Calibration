...
//     cout << "Robot_tr_011 = " << endl << " " << ReverseVector(robot_tr_01) << endl << endl;
    ...
    calibrateHandEye(R_gripper2base, t_gripper2base, R_target2cam, t_target2cam, R_cam2gripper, t_cam2gripper, CALIB_HAND_EYE_DANIILIDIS);
...
int main(int argc, char* argv[])
{
    ...
    */
    rtde_control.moveJ(new_q, 1.05, 1.4);
