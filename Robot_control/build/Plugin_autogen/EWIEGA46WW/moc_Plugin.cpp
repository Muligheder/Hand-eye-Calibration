...
QT_MOC_LITERAL(9, 111, 15), // "startRobotMimic"
QT_MOC_LITERAL(10, 127, 17), // "startRobotControl"
QT_MOC_LITERAL(11, 145, 14), // "startHomeRobot"
QT_MOC_LITERAL(12, 160, 12), // "connectRobot"
QT_MOC_LITERAL(13, 173, 9), // "stopRobot"
QT_MOC_LITERAL(14, 183, 15), // "teachModeToggle"
QT_MOC_LITERAL(15, 199, 10), // "printArray"
QT_MOC_LITERAL(16, 210, 19), // "std::vector<double>"
QT_MOC_LITERAL(17, 230, 7), // "addMove"
QT_MOC_LITERAL(18, 238, 20), // "createPathRRTConnect"
QT_MOC_LITERAL(19, 259, 34) // "std::vector<std::vector<doubl..."

    },
    "Plugin\0clickEvent\0\0stateChangedListener\0"
    "rw::kinematics::State\0state\0RunRobotMimic\0"
    "RunRobotControl\0RunHomeRobot\0"
...
static const uint qt_meta_data_Plugin[] = {
 ...
 // slots: parameters
    ...
    0x80000000 | 16, 0x80000000 | 16, QMetaType::Double, QMetaType::Double,    2,    2,    2,
    QMetaType::Void, 0x80000000 | 16, 0x80000000 | 16, QMetaType::Double, 0x80000000 | 19, 0x80000000 | 4,    2,    2,    2,    2,    2,
...
void Plugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->startRobotMimic(); break;
        case 6: _t->startRobotControl(); break;
        case 7: _t->startHomeRobot(); break;
        case 8: _t->connectRobot(); break;
        case 9: _t->stopRobot(); break;
        case 10: _t->teachModeToggle(); break;
        case 11: _t->printArray((*reinterpret_cast< std::vector<double>(*)>(_a[1]))); break;
        case 12: { std::vector<double> _r = _t->addMove((*reinterpret_cast< std::vector<double>(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3])));
            if (_a[0]) *reinterpret_cast< std::vector<double>*>(_a[0]) = std::move(_r); }  break;
        case 13: _t->createPathRRTConnect((*reinterpret_cast< std::vector<double>(*)>(_a[1])),(*reinterpret_cast< std::vector<double>(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3])),(*reinterpret_cast< std::vector<std::vector<double> >(*)>(_a[4])),(*reinterpret_cast< rw::kinematics::State(*)>(_a[5]))); break;
        default: ;
        }
    }
}
